...
const en = {
    message: {
        ...
        'email': 'Email',
        'webhook': 'Webhook',
        'welcomeTitle': 'Welcome to use Pandora-Job!',
        'login': 'Login',
        'logout': 'Logout',
        ...
        'pythonFilePathPLH': 'Python file path',
        'javaFilePathPLH': 'java file path',
        'javaWindowsPLH': 'java file path under Windows',
        'pythonWindowsPLH': 'Python file path under Windows',
        'exePLH': 'exe file path under Windows',
